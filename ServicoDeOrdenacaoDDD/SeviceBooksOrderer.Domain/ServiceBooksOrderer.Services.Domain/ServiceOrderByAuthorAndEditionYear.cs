...
{
    public class ServiceOrderByAuthorAndEditionYear : IBooksOrderer
    {
        ...
        {           
                ...
                if (order == asc)
                {
                    ListBooks = (from o in BookList
                                 orderby o.authorName ascending, o.editionYear descending
                                 select o).ToList();
                }
                else if (order == desc)
                {

                    ListBooks = BookList.OrderByDescending(o => o.authorName).ThenBy(o => o.editionYear).ToList();
                }
